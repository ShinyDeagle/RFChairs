...
public class BlockFilter {
    ...
    public static boolean isWhitelist(Material type, String category) {
        if (whitelist.contains("ALL_" + category)) return true;
        return whitelist.contains(type.name());
    }
    
    public static boolean isBlacklist(Material type, String category) {
    ...
    public static boolean validateCarpet(Material type) {
        return isWhitelist(type, "CARPET") && !isBlacklist(type, "CARPET");
    }
    
    public static boolean validateSlab(Material type) {
        return isWhitelist(type, "SLAB") && !isBlacklist(type, "SLAB");
    }
    
    public static boolean validateStairs(Material type) {
        return isWhitelist(type, "STAIRS") && !isBlacklist(type, "STAIRS");
    }
